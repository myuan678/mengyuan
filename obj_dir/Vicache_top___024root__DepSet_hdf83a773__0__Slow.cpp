...
VL_ATTR_COLD void Vicache_top___024root___eval_static(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___eval_static\n"); );
}

VL_ATTR_COLD void Vicache_top___024root___eval_initial__TOP(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___eval_initial__TOP\n"); );
    // Body
    vlSelf->downstream_rxsnp_rdy = 0U;
    vlSelf->downstream_txrsp_rdy = 1U;
}

VL_ATTR_COLD void Vicache_top___024root___eval_final(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___eval_final\n"); );
}
...
VL_ATTR_COLD void Vicache_top___024root___eval_settle(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___eval_settle\n"); );
    // Init
...
#endif
            VL_FATAL_MT("/home/xuemengyuan/try/cache_v1/icache_v1_1008_release/icache_top.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vicache_top___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vicache_top___024root___dump_triggers__stl(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vicache_top___024root___stl_sequent__TOP__0(Vicache_top___024root* vlSelf);

VL_ATTR_COLD void Vicache_top___024root___eval_stl(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        Vicache_top___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vicache_top___024root___stl_sequent__TOP__0(Vicache_top___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vicache_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vicache_top___024root___stl_sequent__TOP__0\n"); );
    // Init
